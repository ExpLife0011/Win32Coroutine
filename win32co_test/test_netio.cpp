...
NetServerTest(
	...
	while (TRUE)
	{
		...
		*sClient = accept(sServer, (sockaddr*)&addrClient, &addrClientLen);
		...
		Win32Coroutine::Coroutine::CoInsertCompatRoutine(0x1000, (LPTHREAD_START_ROUTINE)clientProc, (LPVOID)*sClient, NULL);
	}
	closesocket(sServer);
	WSACleanup();
	return;
...
test_netio() {
	...
	printf("launch netio test:\n");

	Coroutine::CoCreateCoroutine(NULL, NetServerTest, NULL, TRUE);
